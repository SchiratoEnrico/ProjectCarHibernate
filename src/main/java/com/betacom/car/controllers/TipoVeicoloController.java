...
public class TipoVeicoloController {
	...
	private final ITipoVeicoloServices veiS;
    ...
    @PostMapping("/create")
    public ResponseEntity<Resp> create(@RequestBody(required = true) TipoVeicoloRequest req) {
        Resp r = new Resp();
        HttpStatus status = HttpStatus.OK;
    ...
    @PutMapping("/update")
    public ResponseEntity<Resp> update(@RequestBody(required = true) TipoVeicoloRequest req) {
        Resp r = new Resp();
        HttpStatus status = HttpStatus.OK;
