...
public class TipoSospensioneController {
	...
	private final ITipoSospensioneServices sospS;
    ...
    @PostMapping("/create")
    public ResponseEntity<Resp> create(@RequestBody(required = true) TipoSospensioneRequest req) {
        Resp r = new Resp();
        HttpStatus status = HttpStatus.OK;
    ...
    @PutMapping("/update")
    public ResponseEntity<Resp> update(@RequestBody(required = true) TipoSospensioneRequest req) {
        Resp r = new Resp();
        HttpStatus status = HttpStatus.OK;
